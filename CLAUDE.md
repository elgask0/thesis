...
- The slide deck in `05_misc/slides/` is the current narrative anchor for thesis framing and supervisor alignment.
...
1. `README.md`
2. `NEXT_STEPS.md`
3. `05_misc/slides/supervisor_meeting_slides.pdf`
...
2. `05_misc/slides/supervisor_meeting_slides.pdf` for current framing and scope
